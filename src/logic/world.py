                    ...
                    if vertical_point[0:2] == "sw":
                        if int(vertical_point[2]) < 7:
                            ...
                            if random.random() < 0.5:
                                ...
                                self.humans.append(Car(self.game, car1_tex, [TILE_SIZE[0]*x_pos + 100*random.random(), TILE_SIZE[1]*y_pos + 150 + 30*random.random()]))
                            if random.random() < 0.1:
                                self.humans.append(Fan(self.game, fan1_tex, [TILE_SIZE[0]*x_pos + 100*random.random(), TILE_SIZE[1]*y_pos + 320 + 30*random.random()]))
